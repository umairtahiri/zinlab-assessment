...
const TwitterIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#4b4b4b">
...
const Footer = () => {
  return (
    <div className="px-40 mt-[72px] bg-gray-100 flex justify-center">
      <div className="w-full ">
        ...
        <div className="flex py-10 justify-between border-t border-b border-gray-300">
          <div className="flex">
